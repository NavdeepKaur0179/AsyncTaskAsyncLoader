package com.app.aynctaskdemo.asyncloader;
...
public class AsyncLoaderActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //To reconnect to the loader, you need an initLoader() method on rotate etc
